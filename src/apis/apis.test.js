...
import { getObtenerPersonaje } from "./getObtenerPersonaje";
import { getTodoPersonajes } from "./getObtenerTodosPersonajes";
import {
...
describe("obtener un personaje", () => {
  it("caso exito: personaje obtenido", async () => {
    ...
    const personaje = await getObtenerPersonaje(2);
...
describe("obtener todos los personajes", () => {
  it("caso exito: todos los personajes", async () => {
    fetch.mockResponseOnce(JSON.stringify(dataTodosPersonajes));

    const personaje = await getTodoPersonajes(1);
    expect(personaje).toMatchObject(dataTodosPersonajes);
    expect(fetch).toHaveBeenCalledTimes(1);
  });
