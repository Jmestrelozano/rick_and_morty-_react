...
export function App({
  ...
  useEffect(() => {}, [detallesPersonaje, episodios]);
  ...
  return (
    ...
    >
      <img
        className="fondo-modal-img"
        src={process.env.PUBLIC_URL + "/assets/img/fondo-modal.png"}
        alt="fondo-modal"
      />
        ...
        <>
          <div className="modal-perfil">
            ...
            <div className="modal-info-perfil">
              ...
              <p className="status-info">{detallesPersonaje[0].species}</p>
            </div>
          </div>
            ...
            <div className="informacion">
              ...
              <div className="contenedor-info-detalle">
                <div className="info-detalle">
                  <p>Gender:</p>
                  <p className="titulo">{detallesPersonaje[0].gender}</p>
                </div>
                <div className="info-detalle">
                  <p>Origin:</p>
                  <p className="titulo">{detallesPersonaje[0].origin.name}</p>
                </div>
                <div className="info-detalle">
                  <p>Type:</p>
                  <p className="titulo">{detallesPersonaje[0].type}</p>
                </div>
              </div>
            </div>
            ...
            <div className="personajes-interesantes">
              ...
              <div className="card-detalle-info">
                {personajesInteresantes.map((personaje, index) => {
                  return <CardDetalleInfo key={index} personaje={personaje} />;
                })}
              </div>
            </div>
          </div>
